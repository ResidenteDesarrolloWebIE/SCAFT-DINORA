...
<!-- <script src="{{asset('plugins/fileinput-5.9/js/plugins/piexif.min.js') }}"></script>
<script src="{{asset('plugins/fileinput-5.9/js/plugins/sortable.min.js') }}"></script>
<script src="{{asset('plugins/fileinput-5.9/js/plugins/purify.min.js') }}"></script>
<script src="{{asset('plugins/fileinput-5.9/themes/fas/theme.min.js') }}"></script> -->
