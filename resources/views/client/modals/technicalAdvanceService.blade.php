<div class="modal fade" id="technicalAdvanceService">
                                ...
                                <center>
                                    <div class="circle" name='cotizacion_fin' id='cotizacion_fin'>
                                        <span class="label-icon">
                                            ...
                                            <p class="tooltip-stage-bottom"><br><strong id="idStage0TechnicalService"></strong></p>
                                        </span>
                                    </div>
                                    ...
                                    <div class="circle" name='aprobacion' id='aprobacion_fin'>
                                        <span class="label-icon">
                                            ...
                                            <p class="tooltip-stage-bottom">Aprobación del Cliente<br><strong id="idStage1TechnicalService"></strong></p>
                                        </span>
                                    </div>
                                    ...
                                    <div class="circle" name='pago' id='pago_fin'>
                                        <span class="label-icon ">
                                            ...
                                            <p class="tooltip-date-top"><strong id="idDateStage2Technical"></strong></p>
                                            <p class="tooltip-stage-bottom">Condiciones<br><strong id="idStage2TechnicalService"></strong></p>
                                        </span>
                                    </div>
                                    ...
                                    <div class="circle" name='compra' id='compra_fin'>
                                        <span class="label-icon">
                                            ...
                                            <p class="tooltip-date-top"><strong id="idDateStage3Technical"></strong></p>
                                            <p class="tooltip-stage-bottom">Servicio<br><strong id="idStage3TechnicalService"></strong></p></span>
                                    </div>
                                    ...
                                    <div class="circle" name='fabricacion' id='fabricacion_fin'>
                                        <span class="label-icon">
                                            ...
                                            <p class="tooltip-date-top"><strong id="idDateStage4Technical"></strong></p>
                                            <p class="tooltip-stage-bottom">Conclucion<br><strong id="idStage4TechnicalService"></strong></p></span>
                                    </div>
                                    <br><br><br><br>   
                                </center>
                            </div>
